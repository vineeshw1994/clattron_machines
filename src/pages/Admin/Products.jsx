                ...
                {paginatedProducts.map(prod => (
                  ...
                  >
                    <div className="flex items-start space-x-3 mb-3">
                      {prod.image ? (
                        <img src={`http://localhost:5000${prod.image}`} alt={prod.name} className="w-16 h-16 object-cover rounded flex-shrink-0" />
                      ) : (
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <button
                          ...
                          className={`text-sm px-2 py-1 rounded ${prod.disabled ? 'text-green-600 hover:text-green-800' : 'text-yellow-600 hover:text-yellow-800'}`}
                        >
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {paginatedProducts.map(prod => (
                      <motion.tr key={prod._id} variants={itemVariants} whileHover="hover">
                        ...
                        <td className="px-6 py-4 text-sm text-gray-500 line-clamp-2 max-w-xs">{prod.description}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{prod.category?.name || 'Uncategorized'}</td>
